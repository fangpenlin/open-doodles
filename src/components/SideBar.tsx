        ...
        <div className="SideBar">
            ...
            <div className="SideBar-author-block">
                <a href="https://twitter.com/fangpenlin">
                    ...
                    >
                        <g id="Web-App" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="Desktop-HD" transform="translate(-25.000000, -961.000000)" fill="#000000">
                ...
                <a href="https://twitter.com/pablostanley">
                    ...
                    >
                        <g id="Web-App" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="Desktop-HD" transform="translate(-26.000000, -985.000000)" fill="#000000">
                                <g id="Credit" transform="translate(24.000000, 955.000000)">
                                    <g id="glyph/color" transform="translate(0.000000, 28.000000)">
                                        <path
